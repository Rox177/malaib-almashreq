  ...
  switch (sport) {
    case "soccer":
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <path d="M12 7.5L9.5 9.5l1 3.5h3l1-3.5L12 7.5z" fill="currentColor" fillOpacity={0.15} />
          <path d="M12 2v5.5M7.5 9.5L2.5 8M9.5 13L5.5 17.5M14.5 13l4 4.5M16.5 9.5L21.5 8M12 22v-5.5" />
          <path d="M2.5 8c1.5.5 3 0 4-1.5M21.5 8c-1.5.5-3 0-4-1.5M5.5 17.5c1 .5 2 0 3-1.5M18.5 17.5c-1 .5-2 0-3-1.5" />
        </svg>
      );
    case "tennis":
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <ellipse cx="14.5" cy="9.5" rx="5" ry="5.5" transform="rotate(-30 14.5 9.5)" fill="currentColor" fillOpacity={0.15} />
          <path d="M11.2 7.2l6.6 3.8M12.7 5.7l6.6 3.8M10.8 10.7l4.5-7.8M12.8 11.7l4.5-7.8" strokeWidth={1} opacity={0.6} />
          <path d="M10.5 13L5 18.5M9.5 14L4 19.5" />
          <path d="M5.5 17.5l-2 2a1 1 0 001.4 1.4l2-2" />
    ...
    case "volleyball":
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <circle cx="12" cy="12" r="10" />
          <path d="M12 2a10 10 0 0110 10M2 12A10 10 0 0112 22" />
          <path d="M12 12L4.5 7.5M12 12l7.5-4.5M12 12v9" />
          <path d="M6 18c3-3 3-6 0-9M18 9c-3 3-3 6 0 9" />
          <path d="M15 4.5c0 4.2-3.4 7.5-7.5 7.5" />
        </svg>
      );
    default:
      return (
